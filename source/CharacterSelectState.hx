...
class CharacterSelectState extends MusicBeatState
{
	...
	[
		...
		new CharacterInSelect(['dave', 'dave-insanity', 'dave-insanity'], [0.25, 0.25, 2, 2], ["Dave", "Dave (Insanity)", 'Dave (Splitathon)']),
		//these are the canon bambis' names according to marcello, dont change them back
		new CharacterInSelect(['dave3d'], [2, 2, 0.25, 0.25], ["3D Dave"]),
	...
	override public function create():Void 
	{
		...
		{
			FlxG.save.data.unlockedcharacters = [true,true,true,true,true,true,true,true];
		}
